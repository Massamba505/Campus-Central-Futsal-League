...
const { top_goals_players, top_assists_players, getAllPlayers, getAllTeams, editPlayer, addMatch, getFixture, getStandings, changeStandings, details, currentMatch } = require('../controllers/features.controller');
